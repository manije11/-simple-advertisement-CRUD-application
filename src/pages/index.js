...
export default function Home() {
    ...
    const [selectItem,setSelectItem]=useState('/en');
    ...
    return (
        <>
            <div className="flex flex-row justify-between">
                <Link className="ml-16 text-white bg-blue-300 hover:bg-blue-100
            focus:ring-4 focus:outline-none focus:ring-blue-600 font-medium
             rounded-lg text-sm px-4 py-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 my-1" href="index"> {(selectItem === '/en') ? 'add Advertisement' : 'Anzeige hinzufügen'}
                ...
                <select onChange={handleLanguage} className="border border-black-200 text-black mr-16 rounded-lg rounded-lg text-sm px-4 py-2 ">
